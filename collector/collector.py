...
class Collector:
    ...
    def __init__(self, currency: str):
        ...
        self.co_currency = CoinoneCurrency[currency.upper()].val
        ...
        self.co_filled_order_col = self.co_db[currency + "_filled_order"]

        # init korbit related
        self.kb_api = KorbitApi()
        self.kb_db = self.client["korbit"]
        self.kb_currency = KorbitCurrency[currency.upper()].val
        ...
        self.kb_filled_order_col = self.kb_db[currency + "_filled_order"]
