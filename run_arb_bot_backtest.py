...
start_time = Global.convert_local_datetime_to_epoch("2018.06.07 09:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.06.08 23:00:00", timezone="kr")
