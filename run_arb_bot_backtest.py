...
start_time = Global.convert_local_datetime_to_epoch("2018.04.24 09:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.04.24 18:00:00", timezone="kr")
