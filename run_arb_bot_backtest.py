...
start_time = Global.convert_local_datetime_to_epoch("2018.05.26 08:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.05.26 20:00:00", timezone="kr")
