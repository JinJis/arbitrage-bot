...
start_time = Global.convert_local_datetime_to_epoch("2018.08.11 00:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.08.12 00:00:00", timezone="kr")
