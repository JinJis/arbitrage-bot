...
start_time = Global.convert_local_datetime_to_epoch("2018.08.16 00:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.08.16 02:55:00", timezone="kr")
