...
start_time = Global.convert_local_datetime_to_epoch("2018.05.09 10:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.05.10 10:00:00", timezone="kr")
