...
start_time = Global.convert_local_datetime_to_epoch("2018.07.12 00:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.07.14 00:00:00", timezone="kr")
