...
start_time = Global.convert_local_datetime_to_epoch("2018.09.05 00:00:00", timezone="kr")
end_time = Global.convert_local_datetime_to_epoch("2018.09.06 00:27:00", timezone="kr")
...
"""IYO 돌릴때 사용하는 것들"""
# DbFixer.check_empty_data_by_rq_time("buthumb", "xrp_orderbook", start_time, end_time)
