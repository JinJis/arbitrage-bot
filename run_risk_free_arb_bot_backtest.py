...
def main():
    ...
    start_time = Global.convert_local_datetime_to_epoch("2018.06.28 13:50:00", timezone="kr")
    end_time = Global.convert_local_datetime_to_epoch("2018.06.29 14:50:00", timezone="kr")
