...
class TradeHandlerV2:
    ...
    def __init__(self, user_id: str, target_currency: str, mm1: MarketManager, mm2: MarketManager):
        ...
        # Mongo Query
        self.trade_cmd_query_key = "trade_commander.%s-%s-%s" % (self.target_currency, self.mm1_name, self.mm2_name)
            ...
            for sliced_time_list in otc_result_dict[trade_type]:
                ...
                for mm1_data, mm2_data in zip(mm1_cursor, mm2_cursor):
                    spread_info_dict = MCTSAnalyzer.min_coin_tradable_spread_strategy(
                        mm1_data, mm2_data, self.mm1.taker_fee, self.mm2.taker_fee, self.streamer_mtcu)
    ...
    def update_trade_commander_to_user_mongo(self):
        self.user_instance.find_user_and_update_streamer(
            user_id=self._user_id, query_dict={
                self.trade_cmd_query_key: TradeCommander.to_dict(
                    time=self.trading_mode_now_time,
                    streamer_mctu=self.streamer_mtcu,
